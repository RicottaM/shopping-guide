    ...
    return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          <Svg width={svgWidth} height={svgHeight} viewBox="0 0 450 300">
            ...
            <SvgText x="40" y="295" fontSize="10" textAnchor="middle" fill={COLORS.text}>Entrance</SvgText>
      
            {/* Exit */}
            <Rect x="390" y="280" width="40" height="20" fill={COLORS.exit} />
            <SvgText x="410" y="295" fontSize="10" textAnchor="middle" fill={COLORS.text}>Exit</SvgText>
      
            {/* Checkout */}
            <Rect x="180" y="250" width="100" height="30" fill={COLORS.checkout} />
            <SvgText x="230" y="270" fontSize="12" textAnchor="middle" fill={COLORS.text}>Checkout</SvgText>
          </Svg>
        </View>
      );
  };
